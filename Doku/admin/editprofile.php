...
<html lang="en">
  <head>
    ...
    <title>Edit Profil | <?php echo $_SESSION['nama'];?> </title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Akun > Profil ><small>Edit Profile</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="proses/proses_editprofile.php" method="post" enctype="multipart/form-data" name="updateadmin" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input onfocusout="validasi()" type="password" id="password" name="password" maxlength="50" placeholder="Masukkan Password" class=" password form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
...
//     function validasi(){
//   if(/\w{5,}/.test(document.getElementById("password").value)){
//     alert("salahh");
//   }
// }
$(document).ready(function(){
  ...
  $(".password").focusout(function(){
   if((/\w{5,}/.test($(this).val()) == false) && $(this).val()!=''){
    $(this).val('');
